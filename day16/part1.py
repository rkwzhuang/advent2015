input_string = """Sue 1: cars: 9, akitas: 3, goldfish: 0
...
for item_pair in analysis_results.split("\n"):
    analysis_dict[item_pair.split(": ")[0]] = item_pair.split(": ")[1]

print(analysis_dict)

input_list = input_string.split("\n")

for sue in input_list:
    item_pairs = sue[sue.index(":")+2:].split(", ")

    # print(item_pairs)
    wrong = False
    for item_pair in item_pairs:
        item = item_pair.split(": ")[0]
        value = item_pair.split(": ")[1]

        if item in ('cats', 'trees'):
            if analysis_dict[item] > value:
                wrong = True
                break
